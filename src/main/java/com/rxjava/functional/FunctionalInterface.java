...
public class FunctionalInterface {
    public static void main(String[] args) {
        ...
        List<Car> carsFilteredByPrice = CarFiler.filterCarByCustomPredicate(cars, new CarPredicate(){
            @Override
        ...
        List<Car> carsFilteredByCarType = CarFiler.filterCarByCustomPredicate(cars, new CarPredicate() {
            @Override
            public boolean test(Car car) {
